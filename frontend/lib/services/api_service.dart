...
class ApiService {
  ...
  static Future<void> deleteCompany(int id) =>
  ...
  static Future<List<dynamic>> getVisitsByDateRange(
  ...
  /// تحديث النتيجة - الآن تقبل unit اختياري
  static Future<void> updateVisitTestResult(int id, String result,
          {String unit = ''}) =>
      DatabaseService.updateVisitTestResult(id, result, unit: unit);
  ...
  // ── Shifts ─────────────────────────────────────────
  static Future<List<dynamic>> getShifts() => DatabaseService.getShifts();

  static Future<int> addShift(Map<String, dynamic> s) =>
      DatabaseService.addShift(s);

  static Future<void> updateShift(int id, Map<String, dynamic> s) =>
      DatabaseService.updateShift(id, s);

  static Future<void> deleteShift(int id) => DatabaseService.deleteShift(id);

  static Future<Map<String, dynamic>?> getShiftForTime(String t) =>
      DatabaseService.getShiftForTime(t);

  // ── Shift Sessions ─────────────────────────────────
  static Future<int> openShiftSession(Map<String, dynamic> data) =>
      DatabaseService.openShiftSession(data);

  static Future<void> closeShiftSession(int id, String endTime) =>
      DatabaseService.closeShiftSession(id, endTime);

  static Future<Map<String, dynamic>?> getOpenSession(int userId) =>
      DatabaseService.getOpenSession(userId);

  static Future<List<dynamic>> getVisitsBySession(int sessionId) =>
      DatabaseService.getVisitsBySession(sessionId);
}